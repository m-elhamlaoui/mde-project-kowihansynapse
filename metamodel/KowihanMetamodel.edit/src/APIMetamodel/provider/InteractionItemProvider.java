...
/**
 * This is the item provider adapter for a {@link APIMetamodel.Interaction} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InteractionItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addUseCaseDescriptionPropertyDescriptor(object);
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 APIMetamodelPackage.Literals.INTERACTION__NAME,
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the Use Case Description feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addUseCaseDescriptionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Interaction_useCaseDescription_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Interaction_useCaseDescription_feature", "_UI_Interaction_type"),
				 APIMetamodelPackage.Literals.INTERACTION__USE_CASE_DESCRIPTION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addHttpMethodPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Interaction_httpMethod_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Interaction_httpMethod_feature", "_UI_Interaction_type"),
				 APIMetamodelPackage.Literals.INTERACTION__HTTP_METHOD,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addEndpointPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Interaction_endpoint_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Interaction_endpoint_feature", "_UI_Interaction_type"),
				 APIMetamodelPackage.Literals.INTERACTION__ENDPOINT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(APIMetamodelPackage.Literals.INTERACTION__PARTICIPANTS);
			childrenFeatures.add(APIMetamodelPackage.Literals.INTERACTION__MESSAGES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(APIMetamodelPackage.Literals.INTERACTION__PARTICIPANTS,
				 APIMetamodelFactory.eINSTANCE.createParticipant()));

		newChildDescriptors.add
			(createChildParameter
				(APIMetamodelPackage.Literals.INTERACTION__MESSAGES,
				 APIMetamodelFactory.eINSTANCE.createMessage()));
	}
