...
/**
 * This is the item provider adapter for a {@link APIMetamodel.Participant} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 APIMetamodelPackage.Literals.PARTICIPANT__NAME,
				 true,
				 false,
				 false,
	...
	protected void addActorTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Participant_actorType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Participant_actorType_feature", "_UI_Participant_type"),
				 APIMetamodelPackage.Literals.PARTICIPANT__ACTOR_TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addEntityNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Participant_entityName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Participant_entityName_feature", "_UI_Participant_type"),
				 APIMetamodelPackage.Literals.PARTICIPANT__ENTITY_NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
