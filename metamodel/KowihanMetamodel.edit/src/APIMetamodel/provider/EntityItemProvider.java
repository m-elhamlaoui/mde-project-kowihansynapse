...
/**
 * This is the item provider adapter for a {@link APIMetamodel.Entity} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EntityItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 APIMetamodelPackage.Literals.ENTITY__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 APIMetamodelPackage.Literals.ENTITY__DESCRIPTION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addIsAbstractPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Entity_isAbstract_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Entity_isAbstract_feature", "_UI_Entity_type"),
				 APIMetamodelPackage.Literals.ENTITY__IS_ABSTRACT,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 APIMetamodelPackage.Literals.ENTITY__TABLE_NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addParentEntityPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Entity_parentEntity_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Entity_parentEntity_feature", "_UI_Entity_type"),
				 APIMetamodelPackage.Literals.ENTITY__PARENT_ENTITY,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(APIMetamodelPackage.Literals.ENTITY__ATTRIBUTES);
			childrenFeatures.add(APIMetamodelPackage.Literals.ENTITY__RELATIONSHIPS);
			childrenFeatures.add(APIMetamodelPackage.Literals.ENTITY__OPERATIONS);
			childrenFeatures.add(APIMetamodelPackage.Literals.ENTITY__INDEXES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(APIMetamodelPackage.Literals.ENTITY__ATTRIBUTES,
				 APIMetamodelFactory.eINSTANCE.createAttribute()));

		newChildDescriptors.add
			(createChildParameter
				(APIMetamodelPackage.Literals.ENTITY__RELATIONSHIPS,
				 APIMetamodelFactory.eINSTANCE.createRelationship()));

		newChildDescriptors.add
			(createChildParameter
				(APIMetamodelPackage.Literals.ENTITY__OPERATIONS,
				 APIMetamodelFactory.eINSTANCE.createOperation()));

		newChildDescriptors.add
			(createChildParameter
				(APIMetamodelPackage.Literals.ENTITY__INDEXES,
				 APIMetamodelFactory.eINSTANCE.createIndex()));
	}
